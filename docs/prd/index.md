...
- [WordCraft Product Requirements Document (PRD)](#table-of-contents)
  ...
  - [Epic 6: Story Mode Integration](./epic-6-story-mode-integration.md)
    ...
    - [Story 6.4: Integrate Story Checkpoints into Game Session](./epic-6-story-mode-integration.md#story-64-integrate-story-checkpoints-into-game-session)
    - [Story 6.5: Create Story Introduction and Finale Screens](./epic-6-story-mode-integration.md#story-65-create-story-introduction-and-finale-screens)
    - [Story 6.6: Add Visual Story Elements to Game UI](./epic-6-story-mode-integration.md#story-66-add-visual-story-elements-to-game-ui)
