...
import { storyProgressMachine, initializeStoryProgress } from '@/machines/story-progress'
import type { StoryProgressContext } from '@/machines/story-progress/types'
import { getCheckpointContent, getIntroContent, getFinaleContent } from '@/lib/story/content'
